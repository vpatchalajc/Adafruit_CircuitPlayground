...
import PasswordVaultAddWebsiteView from '@/stories/projects/veera-playground/Pages/PasswordVaultAddWebsiteView.vue';
import PasswordVaultCredentialsView from '@/stories/projects/veera-playground/Pages/PasswordVaultCredentialsView.vue';
import PasswordVaultFoldersView from '@/stories/projects/veera-playground/Pages/PasswordVaultFoldersView.vue';
import PasswordVaultUsersView from '@/stories/projects/veera-playground/Pages/PasswordVaultUsersView.vue';
    ...
    items: [
      {
        ...
        name: 'Veera Patchala',
        email: 'veera.patchala@jumpcloud.com',
        initials: 'VP',
      },
      { separator: true },
      {
...
const AdminPortalWithPasswordManagerStory = defineComponent({
  ...
  setup() {
    ...
    const addWebsitePageHeaderIcon = markRaw(
      defineComponent({
        name: 'AddWebsitePageHeaderIcon',
        inheritAttrs: false,
        setup(_, { attrs }) {
          return () =>
            h(GlobeAltIcon, {
    ...
    const weakCredentials = [
      { name: 'AWS Primary', metaValue: 'Key Credential', metaClass: 'text-error-base' },
      { name: 'Test 10', metaValue: 'Password Credential', metaClass: 'text-error-base' },
      { name: 'AWS Primary', metaValue: 'Password Credential', metaClass: 'text-error-base' },
    ...
    const unusedCredentials = [
      { name: 'AWS Primary', metaLabel: 'Key: Last Used', metaValue: '46 days ago', metaClass: 'text-error-base' },
      { name: 'Test 10', metaLabel: 'Password: Last Used', metaValue: '123 days ago', metaClass: 'text-error-base' },
      { name: 'AWS Primary', metaLabel: 'Password: Last Used', metaValue: '53 days ago', metaClass: 'text-error-base' },
    ...
    const recentConnections = [
      { user: 'Veera Patchala', server: 'JS-PROD-01', time: '2m ago', event: 'Connected to Prod PostgreSQL' },
      ...
      { user: 'Veera Patchala', server: 'JS-AWS-E1', time: '3h ago', event: 'Connected to Finance Admin Console' },
    ];
    ...
    const lastRecordingData = [
      { resourceName: 'Prod PostgreSQL', type: 'Database', credential: 'svc-pam', user: 'veera.patchala', jumpServer: 'JS-PROD-01', sessionDuration: '00:26:12' },
    ...
    const sessionHistoryData = [
      { name: 'Finance Admin Console', sessionId: 'S-10291', connector: 'Connector-01', credential: 'aws-root', category: 'Website', email: 'veera.patchala@jumpcloud.com', start: 'Apr 6, 2026 09:42', end: 'Apr 6, 2026 10:01', status: 'Available' },
      ...
      { name: 'HR Admin Console', sessionId: 'S-10277', connector: 'Connector-03', credential: 'hr-admin', category: 'Website', email: 'veera.patchala@jumpcloud.com', start: 'Apr 5, 2026 17:20', end: 'Apr 5, 2026 17:43', status: 'Available' },
      ...
      { name: 'Payroll Admin Console', sessionId: 'S-10244', connector: 'Connector-01', credential: 'payroll-admin', category: 'Website', email: 'veera.patchala@jumpcloud.com', start: 'Apr 4, 2026 12:18', end: 'Apr 4, 2026 12:49', status: 'Available' },
      ...
      { name: 'Okta Admin', sessionId: 'S-10215', connector: 'Connector-03', credential: 'okta-admin', category: 'Website', email: 'veera.patchala@jumpcloud.com', start: 'Apr 3, 2026 11:42', end: 'Apr 3, 2026 12:07', status: 'Available' },
    ...
    const sharingUsersData = [
      { id: 'u1', name: 'Veera Patchala', email: 'veera.patchala@company.com' },
    ...
    const vaultWebsitesViewMode = ref<'list' | 'add'>('list');
    watch(passwordVaultTab, (tab) => {
      if (tab !== 'websites') {
        vaultWebsitesViewMode.value = 'list';
      }
    });
    ...
    function openVaultWebsitesDialog() {
      vaultWebsitesSelection.value = [];
      vaultWebsitesViewMode.value = 'add';
    }

    function closeVaultAddWebsiteView() {
      vaultWebsitesViewMode.value = 'list';
    }
    ...
    const VaultWebsiteNameCell = defineComponent({
      ...
      template: `
        <div class="flex h-full min-h-0 min-w-0 w-full max-w-full flex-1 items-stretch border-r border-neutral-default_solid px-2 py-1">
          <DataTableCellLink
            ...
            :image-alt="'Favicon for ' + data.name"
          />
        </div>
      `,
    });
    ...
    return {
      ...
      vaultWebsitesViewMode,
      openVaultWebsitesDialog,
      closeVaultAddWebsiteView,
    ...
    <div class="flex h-screen overflow-hidden">
      ...
      >
        ...
        <template v-else-if="currentPage === 'password-vault'">
          <PageHeader
            v-if="passwordVaultTab === 'websites' && vaultWebsitesViewMode === 'add'"
            title="Add Website"
            :icon="addWebsitePageHeaderIcon"
          >
            <template #actions>
              <div class="flex items-center gap-sm">
                <PvButton
                  ...
                  severity="secondary"
                  variant="text"
                  @click="closeVaultAddWebsiteView"
                >
                  <template #icon="iconProps">
        ...
        <template v-else-if="currentPage === 'password-vault'">
          <div class="flex min-h-0 min-w-0 flex-1 flex-col bg-neutral-surface">
            <DashboardPageLayout
            ...
            <ListPageLayout
              ...
              class="flex min-h-0! min-w-0! h-full! w-full! border-0"
            >
              <PasswordVaultAddWebsiteView
                v-if="vaultWebsitesViewMode === 'add'"
                class="flex min-h-0 min-w-0 h-full w-full flex-1 flex-col"
                @cancel="closeVaultAddWebsiteView"
                @save="closeVaultAddWebsiteView"
              />
              <template v-else>
              <div class="flex flex-col h-full gap-lg">
                <div class="flex flex-col h-full relative">
            ...
            <PasswordVaultCredentialsView
              ...
              class="flex min-h-0 min-w-0 h-full flex-1"
            />
...
const meta: Meta<typeof AdminPortalWithPasswordManagerStory> = {
  title:
    "Projects/Veera Playground/PasswordVault-Admin/PasswordVault",
